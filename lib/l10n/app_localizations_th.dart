...
class AppLocalizationsTh extends AppLocalizations {
  ...
  String get about_me_text =>
      'ผมเป็นวิศวกรซอฟต์แวร์ที่มีความสามารถรอบด้านและหลงใหลในการสร้างผลิตภัณฑ์แบบ End-to-End ที่แข็งแกร่ง ด้วยรากฐานที่มั่นคงด้านปัญญาประดิษฐ์ (AI) และการพัฒนาข้ามแพลตฟอร์ม ผมสามารถปรับตัวเข้ากับเทคโนโลยีใหม่ๆ ได้อย่างรวดเร็วเพื่อแก้ปัญหาที่ซับซ้อน ตั้งแต่การสร้างแอปพลิเคชันมือถือที่ปรับขนาดได้และเกม 2D แบบอินเทอร์แอคทีฟ ไปจนถึงวิศวกรรมหุ่นยนต์ที่ขับเคลื่อนด้วย AI และฮาร์ดแวร์แบบฝังตัว ผมใช้ Tech Stack ที่หลากหลาย (Python, C++, Flutter, Godot) เพื่อเปลี่ยนแนวคิดที่ทะเยอทะยานให้กลายเป็นความจริงที่ใช้งานได้จริง';
