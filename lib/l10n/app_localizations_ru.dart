...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get about_me_text =>
      'Я универсальный инженер-программист, увлеченный созданием надежных продуктов полного цикла (end-to-end). Обладая сильной базой в области искусственного интеллекта и кроссплатформенной разработки, я быстро адаптируюсь к новым технологиям для решения сложных задач. От развертывания масштабируемых мобильных приложений и интерактивных 2D-игр до разработки робототехники на базе ИИ и встраиваемого оборудования — я использую разнообразный стек технологий (Python, C++, Flutter, Godot), чтобы превращать смелые концепции в работающие решения.';
