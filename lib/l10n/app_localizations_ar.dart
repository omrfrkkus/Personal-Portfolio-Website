...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get about_me_text =>
      'أنا مهندس برمجيات متعدد المهارات وشغوف ببناء منتجات قوية ومتكاملة (end-to-end). بفضل أساسي المتين في الذكاء الاصطناعي والتطوير متعدد المنصات، أتكيف بسرعة مع التقنيات الجديدة لحل المشكلات المعقدة. من نشر تطبيقات الهواتف المحمولة القابلة للتوسع والألعاب ثنائية الأبعاد التفاعلية إلى هندسة الروبوتات الموجهة بالذكاء الاصطناعي والأجهزة المدمجة، أستفيد من مجموعة تقنيات متنوعة (Python، C++، Flutter، Godot) لتحويل المفاهيم الطموحة إلى حقائق وظيفية.';
